...
export default function Dedicatoria() {
  ...
  return (
    <section ref={ref} className="max-w-3xl mx-auto px-3 sm:px-4 relative z-10">
      <div className={`css-fade-up ${isInView ? 'visible' : ''} glass-card rounded-[1.5rem] sm:rounded-[2rem] md:rounded-[4rem] p-6 sm:p-8 md:p-16 text-center relative overflow-hidden`}>
        {/* Corner decorations */}
        ...
        <p className={`css-fade ${isInView ? 'visible' : ''} font-serif italic text-xl sm:text-2xl md:text-4xl text-bordeaux mb-6 sm:mb-8 leading-relaxed`} style={{ transitionDelay: '0.3s' }}>
        ...
        <p className={`css-fade ${isInView ? 'visible' : ''} text-gray-500 text-xs sm:text-sm md:text-base leading-relaxed mb-6 sm:mb-8 px-2 sm:px-4`} style={{ transitionDelay: '0.6s' }}>
        ...
        <div className={`css-fade-up ${isInView ? 'visible' : ''} flex items-center justify-center gap-3`} style={{ transitionDelay: '0.8s' }}>
